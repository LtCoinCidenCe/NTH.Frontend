...
const ErrorToast: React.FC<{ message: string, isShow: boolean, onClose: () => void }> =
  ({ message, isShow, onClose }) => {
    ...
    return (
      ...
      <div
        className={`fixed top-4 left-1/2 transform -translate-x-1/2 z-50 transition-all duration-300 ease-in-out ${isShow ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-[-20px] pointer-events-none'
          }`}
